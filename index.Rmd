...
##Milestone 4
```{r}
##Same code from milestone 3 as I want to maintain the same substance for my graph, but now add in a regression line to better visualize the relationship in my data
